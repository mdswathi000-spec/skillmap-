...
st.set_page_config(page_title="SkillMap", layout="wide")

st.title("Welcome to SkillMap")
st.write("Your project is officially running on Streamlit!")

# This is a Python comment. Use '#' instead of '//'